...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between text-lg  mb-7 border-b border-b-gray-400 sticky top-0 z-50 rounded-4xl bg-[#0a1628]">
      <img
        onClick={() => navigate("/")}
        src={miafyalogo}
        alt="miafya"
      ...
      />
      <ul className="hidden md:flex items-start gap-5 font-medium bg-[#0a1628]">
        <NavLink to="/">
