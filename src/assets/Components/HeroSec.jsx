...
const HeroSec = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20 m-4">
      {/* .....left side........ */}
      <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]">
        <p className="text-3xl md:text-4xl lg:text-5xl text-white font-semibold leading-tight md:leading-tight lg:leading-tight">
          We help you connect <br /> With Trusted Health Professionals and Health Facilities
        </p>
        <div className="flex flex-col md:flex-row items-center gap-3px text-white  text-sm font-light">
          ...
          <p className="text-white ">
            Simply browse through our extensive list of trusted doctors,clinicians, therapists, Nurses
