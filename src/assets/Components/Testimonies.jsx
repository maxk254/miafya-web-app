  ...
  return (
    <div className="text-center">
      ...
      <p className="text-sm md:text-base text-gray-500 mt-4">
        Join thousand of users whose lives were transformed and the successfull
        got medical attention
      </p>
      <div className="flex flex-wrap justify-center gap-5 mt-16 text-left">
        <div className="w-80 flex flex-col items-start border border-teal-100 p-5 rounded-lg bg-white">
          <svg
            width="44"
            height="40"
            viewBox="0 0 44 40"
          ...
          <p className="text-sm mt-3 text-gray-500">
            I've been using miafya for nearly two years,it has helped me save
            alot of time since i dont have to go to the hospital que for hours
            to see a doctor
          </p>
          <div className="flex items-center gap-3 mt-4">
            <img
              className="h-12 w12 rounded-full"
              src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=10o"
              alt="userImage1"
            />
            <div>
              ...
              <p className="text-sm text-gray-500">@ max_Mwangi</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-80 flex flex-col items-start border border-teal-100 p-5 rounded-lg bg-white">
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">@ otieno_omondi</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-80 flex flex-col items-start border border-teal-100 p-5 rounded-lg bg-white">
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            />
            <div>
              <h2 className="text-lg text-gray-900 font-medium">Jane Nafula</h2>
              <p className="text-sm text-gray-500">@ jane_nafula</p>
            </div>
          </div>
        </div>
      </div>
